export const vanishing_linesPhotos = [
    ...
    },
    {
      ...
      height: 1200,
      alt: '4-vanishing-lines',
      caption: "vanishing line 5",
      thumb: require('./img/thumbs/thumb-4-vanishing-lines-Vanishing_Line_5.jpg').default,
    }
