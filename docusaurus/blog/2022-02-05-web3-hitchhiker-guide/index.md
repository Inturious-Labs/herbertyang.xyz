...
## Challenges of Learning Blockchain
...
## Where to Start on Web3 and Crypto

First, start with Twitter. The following IDs will usher you into several interesting realms.

*   [Elon Musk](https://twitter.com/elonmusk) The one that moves the market
*   [Vitalik Buterin](https://twitter.com/VitalikButerin) Creator of Ethereum
*   [Dominic Williams](https://twitter.com/dominic_w) Founder of DFINITY
*   [Lyn Alden](https://twitter.com/LynAldenContact) One of the best working economists today, especially on inflation
*   [Matthew Ball](https://twitter.com/ballmatthew) Prolific writer on Metaverse and Gaming
*   [Naval Ravikant](https://twitter.com/naval) The Yoda that utters words of deep thoughts
*   [Balaji Srinivasan](https://twitter.com/balajis) Crypto intellectual tour de force
*   [Wu Blockchain](https://twitter.com/WuBlockchain) Crypto news from China and the world
*   [Odaily China Crypto News](https://twitter.com/OdailyChina) One of the few remaining crypto media outlets that still report out of China
*   [Chinese Crypto Twitter Hall of Famer](https://twitter.com/i/lists/1449651877751050242) A widely followed list of 63 prominent Chinese KOLs in crypto

Podcast provides the best fresh content on crypto. Below are my favorites. Be careful about your dosage. They can be very addictive - for sheer high-quality speakers and contents that could induce a high level of stress, anxiety, and FOMO.

*   [Bankless](https://linktr.ee/Bankless) Weekly crypto news, one of the best in the business
*   [Techmeme](https://www.techmeme.com/) Daily crypto/tech news in usually 20-minute segments
*   [Lex Fridman Podcast](https://lexfridman.com/podcast/) Best interviewer on technology with all-star speakers like Elon Musk, Charles Hoskinson, and Neal Stephenson
*   [Tim Ferriss Podcast](https://linktr.ee/timferriss) Best interviewer in general with speakers like Jamie Foxx, Naval, Vitalik, and Nick Szabo
*   [Unchained Podcast by Laura Shin](https://www.laurashin.com/podcast/) Twice-weekly podcast on all things crypto
...
*   [The Bitcoin Standard: The Decentralized Alternative to Central Banking](https://www.amazon.com/Bitcoin-Standard-Decentralized-Alternative-Central/dp/1119473861/ref=sr_1_1?crid=1ZTVHX03U8YC9&keywords=bitcoin+standard&qid=1643942302&sprefix=bitcoin+standard%2Caps%2C603&sr=8-1) Saifedean Ammous' seminal book on Bitcoin to answer the most frequently asked question in crypto
*   [The Infinite Machine: How an Army of Crypto-hackers Is Building the Next Internet with Ethereum](https://www.amazon.com/Infinite-Machine-Crypto-hackers-Building-Internet-ebook/dp/B07X8HS2WC/ref=sr_1_5?crid=AQP29TA7J2V7&keywords=ethereum&qid=1643942433&sprefix=ethereum%2Caps%2C534&sr=8-5) Camila Russo's book vividly captures the early days of being wild when Ethereum was created. Fun read to understand the origin of crypto's culture and key players.
*   [Snow Crash](https://www.amazon.com/Snow-Crash-Novel-Neal-Stephenson-ebook/dp/B000FBJCJE/ref=sr_1_1?crid=29JPOCJM0TVTI&keywords=snow+crash&qid=1643942639&sprefix=snow+cras%2Caps%2C687&sr=8-1) Neal Stephenson's famed sci-fi novel published in 1992 introduced the concept of metaverse.

Reading whitepaper is the right way to sink into blockchain. We like it hard-core.

*   [Bitcoin: A Peer-to-Peer Electronic Cash System by Satoshi Nakamoto in 2008](https://bitcoin.org/bitcoin.pdf) It's a masterpiece that should be enshrined in US Library of Congress. An uncanny amount of wisdom is condensed in this 9-pager doc.
*   [Ethereum Whitepaper by Vitalik Buterin in 2013](https://ethereum.org/en/whitepaper/) Vitalik introduced smart contract to blockchain, that forever changed the face of the Internet.
...
## Where to Start Researching on DFINITY and ICP
...
Read up the updated IC Whitepaper here: [The Internet Computer for Geeks (v1.1)](https://dfinity.org/whitepaper.pdf), which was just released on Jan 27, 2022. The previous whitepaper was written and published in 2018, way before the launch of IC mainnet ("Genesis") on May 10, 2021. A lot has changed since then. It's a 45-page pdf doc and written by some of the best cryptographers and software architects in the world.

[DFINITY's channel on reddit](https://www.reddit.com/r/dfinity/) is another great place to observe how DFINTY team engages the IC community. It speaks a lot to DFINITY's ethos, vision, and capabilities. In particular, [Diego from DFINITY](https://www.reddit.com/user/diego_DFN/) wrote this excellent [MEGATHREAD: Technical AMAs](https://www.reddit.com/r/dfinity/comments/ozboyi/megathread_technical_amas/) that points to all 9 AMAs from DFINITY's R&D team during May to Aug 2021 after Genesis. Each team in the R&D organization took turns to field questions from developers. It's a fantastic learning experience.

[Youtube](https://www.youtube.com/c/DFINITY) has some very good videos on DFINITY and IC. Three series are fairly up to date and most useful. [Inside DFINITY by founder Dominic Williams](https://youtube.com/playlist?list=PLuhDt1vhGcrdoGdyf2Hy0doX9Zy1dwo-Z) is a good start. [Community Conversations hosted by Liz Yang](https://youtube.com/playlist?list=PLuhDt1vhGcrez-f3I0_hvbwGZHZzkZ7Ng) is a treasure island. [Coding with Kyle by Kyle Peacock](https://youtube.com/playlist?list=PLuhDt1vhGcrfQGLWqhUo9-DFD5JaHqCh1) teaches you how to build a site on IC.

This Medium article [DFINITY in 2021: A Year of Developer and Community Growth on the Internet Computer](https://medium.com/dfinity/dfinity-in-2021-a-year-of-developer-and-community-growth-on-the-internet-computer-2b8bd36450d8) rewinds 2021 and highlights key accomplishments in IC's ecosystem building. Another Medium article [The Internet Computer Community Adopts 25 Proposals for Future Crypto Innovation](https://medium.com/dfinity/the-internet-computer-community-adopts-25-proposals-for-future-crypto-innovation-7465984c5ad1) indexes 25 proposals that were adopted by the IC community toward the end of 2021, each of which came with a detailed scope and technical elaboration. A technology team's capability and commitment are best validated by its ability to deliver milestones along its roadmap consistently. DFINITY has a very comprehensive and ambitious [post-Genesis roadmap for 2022 and beyond](https://medium.com/dfinity/the-internet-computers-post-genesis-r-d-roadmap-dce2938adcde). These three Medium articles collectively would give a full picture of ICP's past, present and future.

[DFINITY Showcase](https://dfinity.org/showcase) highlights notable projects in the ecosystem of the Internet Computer. Explore true Web3 dApps in NFT, Social, Games, Metaverse, DeFi, Infrastructure, Enterprise and Productivity. Try them out yourself before drawing conclusion on what blockchain can or cannot do or publish your "first impression on Web3" article.

Besides the above sites/articles from the DFINITY team, my own [Twitter ID @herbertyang](https://twitter.com/herbertyang) is a good spot to keep track of the latest happenings and growth of DFINITY and IC ecosystem in Asia. [My pinned tweet](https://twitter.com/herbertyang/status/1457848063041556485) is a thread of threads that chronicle all the major events by DFINITY team or key players in the IC community. If someone would like to conduct a due diligence background check on DFINITY/IC, want to know our key activities since Genesis, find out which are the rising star projects that have the potential of becoming the next Web3 unicorn, or which crypto investors we like to partner with, this digital garden of forking paths has all the answers for a dedicated seeker.
...
1.  Register an Internet Identity anchor/account at [identity.ic0.app](https://identity.ic0.app/), which is created and managed by DFINITY. This is your passport to authenticate your identity in all the ICP dApps. You can do this on your iPhone or Windows phone. It's free to register an Internet Identity ("II") anchor/account. You can register as many II accounts as you like.
2.  Login to your [NNS (Network Nervous System) account](https://nns.ic0.app/v2/). NNS site is also created and managed by DFINITY. It's the official (hot) wallet that can manage your ICP token, transfer ICP, stake ICP, participate in the NNS governance (NNS is a DAO), and manage your canisters (in a similar fashion as you would manage your AWS dashboard). Get the **Principal ID** from your NNS account. This is the wallet address that can be shared publicly for you to receive ICP token. Login to NNS requires authentication by Internet Identity ("II").
3.  Get some ICP tokens via means that are available to you in a manner that's allowed in your local country. Once the ICP tokens are in the custodian wallet of your exchange account, transfer them to your own wallet, which is identified by the Principal ID in Step 2.
4.  Return to your NNS dashboard. You shall see the balance of your account has been topped up. The transfer is almost instantaneous within 1-2 seconds. No need to pay any gas fee other than the transaction fee charged by your exchange platform.
5.  You can do many things with NNS wallet, but not for buying NFT. You need a third-party wallet for NFT. Two wallets are most popular for ICP holders for NFT, [Plug](https://twitter.com/plug_wallet) and [Stoic](https://twitter.com/StoicWalletApp). They are developed not by DFINITY but by independent IC developers. Sign up for both of them and transfer some ICP tokens to your new wallets.
...
## Desirable Qualities to Excel in DFINITY and Web3
...
* [About DFINITY Foundation](https://dfinity.org/foundation)
* [ICP Dashboard](https://dashboard.internetcomputer.org/)
* [DFINITY Team](https://dfinity.org/foundation#team)
* [Developer Grant Program](https://dfinity.org/grants)
* [Community Awards Program](https://dfinity.org/community)
* [Developer Center](https://smartcontracts.org/)
* [DFINITY on Twitter](https://twitter.com/dfinity)
* [DFINITY on Facebook](https://www.facebook.com/dfinity.org/)
* [DFINITY on Linkedin](https://www.linkedin.com/company/dfinity)
* [DFINITY on Medium](https://medium.com/dfinity)
* [DFINITY on Youtube](https://www.youtube.com/c/DFINITY)